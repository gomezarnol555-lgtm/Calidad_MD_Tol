...
def pdf_pnc(rid):
    ...
    try:
        ...
        return None
    df = consultar(operacion_datos('REPORTES_0021'), (rid,))
    if df.empty:
        return None
    r = df.iloc[0].to_dict()
...
def pdf_pnc_fisico(rid):
    ...
    try:
        ...
        return None
    df = consultar(operacion_datos('REPORTES_0022'), (rid,))
    if df.empty:
        return None
    r = df.iloc[0].to_dict()
...
def _pdf_hallazgo_base(tabla, rid, tipo_formato):
    ...
    try:
        ...
        return None
    df = consultar(operacion_datos('REPORTES_0023', tabla), (rid,))
    if df.empty:
        return None
    r = df.iloc[0].to_dict()
    ...
    if tipo_formato == 'ME':
        ...
        t(c, 'MUESTRA DEL MATERIAL HALLADO', 28, 267, 8, True)
...
def pdf_entrega(eid):
    try:
        ...
        return None
    h = consultar(operacion_datos('REPORTES_0024'), (eid,))
    d = consultar(operacion_datos('REPORTES_0025'), (eid,))
    m = consultar(operacion_datos('REPORTES_0026'), (eid,))
    sg = consultar(operacion_datos('REPORTES_0027'), (eid,))
    if h.empty:
        return None
    r = h.iloc[0]
    b = BytesIO()
