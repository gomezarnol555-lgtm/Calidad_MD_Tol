            ...
            if guardar:
                ...
                if missing:
                    ...
                    updates = {
                        ...
                        if campo in columnas_disponibles and campo != 'id'
                    }
                    ...
                    try:
                        ...
                        st.error('No pude guardar porque otro registro utiliza una combinación que debe ser única.')
                    except Exception as exc:
                        st.error('No pude actualizar el registro en la base de datos configurada.')
                        st.caption(str(exc))
                    else:
                        if afectados < 1:
                            st.warning('No se actualizó ninguna fila. El registro pudo cambiar en otra sesión.')
                        else:
