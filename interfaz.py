                ...
                crear(
                    {
                        ...
                        'columnas': ['tipo_entidad', 'entidad', 'periodo_tipo', 'periodo_clave', 'meta', 'actualizado_por', 'actualizado_en'],
                        'upsert': True,
                        'ignorar': False,
                    },
                    (
            ...
            for entidad, fecha_columna, valor in cambios:
                if valor is None:
                    crear(
                        ...
                        (tipo_entidad, entidad, fecha_columna),
                    )
                else:
                    crear(
                        {
                            'accion': 'crear',
                            'tabla': 'ajustes_diarios_spac',
                            'columnas': ['tipo_entidad', 'entidad', 'fecha', 'valor', 'justificacion', 'actualizado_por', 'actualizado_en'],
                            'upsert': True,
                            'ignorar': False,
                        },
                        (
        ...
        with st.expander('✏️ Editar o completar registro', expanded=True):
            ...
            if guardar:
                ...
                if missing:
                    ...
                    updates = {**values, **auto}
                    # La consulta SELECT * ya devuelve el esquema efectivo expuesto
                    # por la capa de datos. No se abre una conexion especifica del motor.
